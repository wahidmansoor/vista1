...
/**
 * @deprecated Use src/modules/tools/Calculators.tsx instead.
 * This file is kept for backward compatibility but is no longer the canonical calculator hub.
 */
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <button
          onClick={() => navigate('/tools/calculators/carboplatin')}
          className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center justify-center space-y-2 hover:scale-105"
        >
          <span className="text-2xl">💊</span>
          <span className="font-semibold text-gray-800 dark:text-gray-200">Carboplatin Calculator</span>
          <span className="text-sm text-gray-600 dark:text-gray-400">Calvert Formula</span>
        </button>
      </div>
    </div>
  );
